					...
					<div className='grid__container'>
						...
						<div className='grid__row'>
							<p className='section__content'>
								Thanks for visiting my personal website. I hope you got a chance to learn a little about me and what I have done in my
								career.
							</p>
							<p className='section__content'>
								If you are looking to hire a web developer or software engineer, make sure to connect with me! We can see if I would
								be a good fit for the position, or at the very least make a professional connection.
							</p>
						</div>
						<div className='grid__row'>
