						...
						<div className="grid__row grid__column--one-half">
							<div className="m-auto max-width-100">
								...
								<p className="section__content">
									Are you a employer or a recruiter? Are you wondering how I
									became a self-taught developer and got where I am today?
								</p>
								<p className="section__content">
									Or are you new development and looking for some resources to
									learn more and add to your own skillset?
								</p>
								<p className="section__content">
									Below are many resources, excluding countless online articles,
									that helped me go from no web devlopment skills to being able to
									build my own personal website with React, and how I got to where
									I am today.
								</p>
							</div>
							<div className="m-auto max-width-100">
