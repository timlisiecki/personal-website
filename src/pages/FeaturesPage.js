					...
					<div className="grid__container">
                        ...
                        <div className="grid__row">
                            <div className="grid__column--twelve">
                                ...
                                <p className="section__content">All CSS is <strong>built from scratch</strong>!</p>
                            </div>               
                            <div className="grid__column--twelve">
                                <h3 className="section__subtitle">BEM Methodology</h3>
                                <p className="section__content">Used the Block Element Modifier (BEM) methodology to code all the CSS, keeping consistent with the "resusable component" mindset of React.</p>
                            </div>               
                            <div className="grid__column--twelve">
                                <h3 className="section__subtitle">Responsiven Web Design</h3>
                                <p className="section__content">Coded a responsive grid system <strong>from scratch</strong>! Check out the responsive-grid.css file in the Github repository.</p>
                            </div> 
                            <div className="grid__column--twelve">
                                <h3 className="section__subtitle">Flexbox</h3>
                                <p className="section__content">Using flex box as much as possible for positioning of elements.</p>
                            </div>              
                        </div>
                    </div>
    			</div>
    				...
    				<div className="grid__container">
                        ...
                        <div className="grid__row">
                            <div className="grid__column--twelve">
                                ...
                                <p className="section__content">Git was used for version control, using branches to create new feeatures and then merging with the master branch.</p>
                            </div>               
                            <div className="grid__column--twelve">
                    ...
                    <div className="grid__container">
                        ...
                        <div className="grid__row">
                            <div className="grid__column--twelve">
                                ...
                                <p className="section__content"><em>Coming Soon</em> - CSS preprocessor.</p>
                            </div>               
                            <div className="grid__column--twelve">
                                <h3 className="section__subtitle">Redux</h3>
                                <p className="section__content"><em>Coming Soon</em> - State management for React components.</p>
                            </div>              
                        </div>
                    </div>
                </div>
